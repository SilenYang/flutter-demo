...
class PageIndicator extends StatelessWidget {
  PageIndicator({this.pageIndicatorViewModel, this.controllContent});
  final PageIndicatorViewModel pageIndicatorViewModel;
  final Widget controllContent;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < pageIndicatorViewModel.pages.length; i++) {
      ...
      if (i == pageIndicatorViewModel.activeIndex) {
        percentActive = 1.0 - pageIndicatorViewModel.slidePercent;
          ...
          i == pageIndicatorViewModel.activeIndex + 1 &&
              pageIndicatorViewModel.slideDirection ==
    ...
    final baseTransition =
        (pageIndicatorViewModel.pages.length * BUBBLE_WIDTH / 2) -
            (BUBBLE_WIDTH / 2);
    var transition =
        baseTransition - (pageIndicatorViewModel.activeIndex * BUBBLE_WIDTH);
